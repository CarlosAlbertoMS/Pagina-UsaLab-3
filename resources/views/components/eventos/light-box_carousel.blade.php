<div id="contenedorCard" class="carousel-item {{ $statusCarouselItem }}" data-id="{{ $diapositiva }}">
    <img src="{{ $imagen }}" class="d-block w-100 slide-image {{ $customClassOffset ?? '' }}" alt="{{ $lugar }}">
    <div id="contenidoCard" class="carousel-caption d-flex flex-column justify-content-center align-items-center"  {{-- style="height: 100%; top: 0; bottom: 0; left: 0; right: 0;" --}} >
